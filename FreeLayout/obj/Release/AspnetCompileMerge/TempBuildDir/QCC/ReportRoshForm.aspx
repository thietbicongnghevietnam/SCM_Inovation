<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportRoshForm.aspx.cs" Inherits="FreeLayout.QCC.ReportRoshForm" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Report Test Rosh Form</title>
    <meta charset="utf-8">
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
            <div style="margin-top: 20px;">
                <h1>Report Rosh Form</h1>
                <div class="col-sm-12" style="margin-top: 10px; margin-bottom: 10px;">
                    <b>Issue Date :</b><input type="text" id="datepicker" runat="server">
                    <button class="btn btn-primary" type="submit" runat="server" onserverclick="Search_roshdate_Click">
        ...
        <div class="container" id="container">
            ...
            <table class="table table-bordered" id="htmltable">
                ...
                <tbody>
                    <%int i = 0; %>
                     <%foreach (System.Data.DataRow rows in dtrosh.Rows)
                        {%>
                    <%i++;%>
                    <tr>
                        <td><%=i %></td>
