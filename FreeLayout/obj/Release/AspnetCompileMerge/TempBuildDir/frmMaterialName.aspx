<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMaterialName.aspx.cs" Inherits="FreeLayout.frmMaterialName" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>MaterialNames</title>
    ...
    <form id="form1" runat="server">
        ...
        <div class="card">
            <div class="card-header">
                <div class="col-sm-12">
                    <h3><b style="font-size: 30px;">Master Names</b></h3>
                    <br />
                    <p style="color: blue;">
  ...
  &nbsp;&nbsp;&nbsp;
        ...
        <div class="modal" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Thêm mới Material Name</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <asp:TextBox ID="Mateialid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
                                <label for="ID">EnglishName</label>
                                <asp:TextBox ID="EnglishNameid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <asp:TextBox ID="VietNameseNameid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
                                <label for="ID">ID</label>
