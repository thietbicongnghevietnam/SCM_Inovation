            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <h1>Material list Fixed location of MCS</h1>
                        <%--class="card-title"--%>
                        <div class="col-sm-12">
                            <b>Delivery Date :</b>
                            ...
                            <button type="button" class="btn" style="margin-left:700px; background-color:#66FF33">
                                Finished Inspection
                            </button>
                            <button type="button" class="btn" style="margin-left:50px;background-color:#99FFFF">
                                checking 
                            </button>
                            <button type="button" class="btn" style="margin-left:50px; background-color:#FFFFCC">
                                Wating check
                            </button>
                            <button type="button" class="btn" style="margin-left:50px; background-color:red">
                                Urgent
                            </button>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <table id="example1" class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <%if ((rows["TTcheck"].ToString() == "waiting") && (rows["Note_urgent"].ToString() != "Urgent"))
                                                {%>
                                            ...
                                            <tr role="row" style="background-color: #FFFFCC">
                                                ...
                                                <td><b style="font-family:Tahoma; font-size:20px; color:blue"><%=rows["Note_urgent"].ToString() %></b></td>
                                                <td>
                                            ...
                                            <% } %>
                                            <%else if ((rows["TTcheck"].ToString() == "checked"))
                                                {%>
                                            <tr role="row" style="background-color: #99FFFF">
                                                <td><%=rows[0].ToString() %></td>
                                                <td><%=rows[1].ToString() %></td>
                                                <td><%=rows[2].ToString() %></td>
                                                <td><%=rows[3].ToString() %></td>
                                            ...
                                            <%}%>
                                            <%else if (rows["TTcheck"].ToString() == "finished")
                                                {%>
                                            ...
                                            <%}%>
                                            <%else if (rows["Note_urgent"].ToString() == "Urgent")
                                                {%>
                                            <tr role="row" style="background-color: #FF0000">
                                                <td><%=rows[0].ToString() %></td>
                                                <td><%=rows[1].ToString() %></td>
                                                <td><%=rows[2].ToString() %></td>
                                                <td><%=rows[3].ToString() %></td>
