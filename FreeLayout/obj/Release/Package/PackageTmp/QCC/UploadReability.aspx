...
<body>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Qty testing</label>
                                        <asp:TextBox ID="txt_qtytest" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:Button runat="server" id="btnadd1" OnClick="SaveClick" CssClass="btn btn-primary" OnClientClick="return CheckValid();" Text="Save"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function openEditModal(txt_id, txt_mahang, txt_cate, txt_vendor, txt_weightofjig, txt_totalcycles, txt_sampleposition, dr_typecheck, txt_levecheck, txt_rohsgroup, txt_rohsqty, txt_rohsmaking, txt_modecheck, txt_plan,txt_qtytest) {
            $("#idcheck").val(txt_id);
