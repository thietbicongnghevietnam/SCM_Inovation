...
<body>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="col-sm-12">
                    ...
                    <button class="btn btn-primary" type="button" runat="server" onserverclick="Search_Date_Click_2">
                        <i class="fa fa-fw fa-lg fa-search"></i>Filter</button>


                    <button type="button" class="btn" style="margin-left: 50px; background-color: #99FFFF" runat="server" onserverclick="Filter_Checking_Click2">
                        Checking
                    </button>
                    <button type="button" class="btn" style="margin-left: 20px; background-color: #FFFF99" runat="server" onserverclick="Filter_Wating_Click2">
                        Waiting
                    </button>
                    <button type="button" class="btn" style="margin-left: 20px; background-color: #66FF33" runat="server" onserverclick="Filter_Finished_OK_Click2">
                        Finished OK
                    </button>
                    <button type="button" class="btn" style="margin-left: 20px; background-color: #FF0000" runat="server" onserverclick="Filter_Finished_NG_Click2">
                        Finished NG
                    </button>

                    <button type="button" class="btn" style="margin-left: 20px; margin-right: 10px; background-color: #FFC1C1" runat="server" onserverclick="Filter_Delete_Check_Click2">
                        Delete checking
                    </button>

                    <button type="button" class="btn" style="margin-left: 20px; margin-right: 20px; background-color: #EEEEEE" runat="server" onserverclick="Filter_not_inspection2">
                        Not Inspection
                    </button>

                    <button type="button" class="btn btn-primary" style="margin-left: 20px;" runat="server" onserverclick="Filter_All_Click_rosh">
                        Filter All
                    </button>

                    <button type="button" class="btn btn-primary" style="margin-left: 20px;" runat="server" onserverclick="btnExportCSV">
                        Export file 14&T18
                    </button>
                ...
                <div class="col-md-3" style="float: left">
                    <div class="form-group">
                        <label for="Group">Filter Plan</label>
                        ...
                        <asp:DropDownList ID="dr_filter_cate" runat="server"
                            AppendDataBoundItems="true"
                            DataTextField="nameplan"
                            DataValueField="nameplan"
                            CssClass="custom-select custom-select-sm form-control form-control-sm">
                        </asp:DropDownList>
                    </div>
                </div>
                ...
                <div class="col-md-3" style="float: left; display: block; margin-top: 30px;" id="userexport">
                    <b style="float: left;">UserID : </b>
                    <asp:TextBox ID="finishexport" CssClass="form-control" runat="server" Style="width: 200px; float: left; margin-left: 5px;"></asp:TextBox>
                </div>

                <div class="col-md-3" style="float: left; display: block; margin-top:30px;" id="">
                    <b style="float:left;">Filter : </b>                     
                    <asp:TextBox ID="filter_type2" CssClass="form-control" runat="server" style="width: 200px; float:left; margin-left:5px;"></asp:TextBox>
                </div>
            ...
            <table id="example1" class="table table-bordered table-hover table-condensed">
                ...
                <tbody>
                    ...
                    <%if (rows[13].ToString() == "pending")
                        {%>
                    <%if (rows[15].ToString() == "Urgent" && rows[34].ToString() != "1")
                        {%>
                    <tr style="background-color: #99FFFF">
                        ...
                        <td>
                            <%=rows[1].ToString() %><br />
                            <a href="#" title="Check item" id="<%= rows[0].ToString() %>" onclick="openEditModal('<%= rows[0].ToString() %>','<%= rows[1].ToString() %>','<%= rows[2].ToString() %>','<%= rows[5].ToString() %>','<%= rows[6].ToString() %>','<%= rows[30].ToString() %>','<%= rows[31].ToString() %>','1','<%= rows[33].ToString() %>')">
                                <i style="width: 50px;" class="fas fa-pencil-alt"></i>
                            </a>
                            <a href="#" title="Finished" onclick="openEditModal2('<%= rows[0].ToString() %>','<%= rows[1].ToString() %>','0','<%= rows[35].ToString() %>','<%= rows[19].ToString() %>')">
                                <i style="width: 50px;" class="fas fa-save"></i></a>
                        </td>
                        ...
                        <td><%=rows[33].ToString() %></td>
                        <td><%=rows[39].ToString() %></td>
                        <%--<td><%=rows[15].ToString() %><i class="far fa-bell"></i></td>
                        <td></td>
                        <td></td>--%>
                        <td><%=rows[35].ToString() %></td>
                        <%--<td><%=rows[25].ToString() %></td>
                        <td><%=rows[22].ToString() %></td>--%>
                        <td><%=rows[45].ToString() %></td>
                        <td><%=rows[18].ToString() %></td>
                        <%--<td><%=rows[23].ToString() %></td>--%>
                        <td><%=rows[24].ToString() %></td>
                        <td>
                            <input type="checkbox" id="<%= rows[0].ToString() %>" value="<%= rows[0].ToString() %>"></td>

                    </tr>
                    <%} %>

                    <%else if (rows[34].ToString() == "1")
                        {%>
                    <tr style="background-color: #FFFF99">
                        ...
                        <td>
                            ...
                            <a href="#" title="Check item" id="<%= rows[0].ToString() %>" onclick="openEditModal('<%= rows[0].ToString() %>','<%= rows[1].ToString() %>','<%= rows[2].ToString() %>','<%= rows[5].ToString() %>','<%= rows[6].ToString() %>','<%= rows[30].ToString() %>','<%= rows[31].ToString() %>','0','<%= rows[33].ToString() %>')">
                                <i style="width: 50px;" class="fas fa-pencil-alt"></i>
                            </a>
                            <a href="#" title="Finished" onclick="openEditModal2('<%= rows[0].ToString() %>','<%= rows[1].ToString() %>','0','<%= rows[35].ToString() %>','<%= rows[19].ToString() %>')">
                                <i style="width: 50px;" class="fas fa-save"></i>
                            </a>
                    ...
                    <%if ((rows[36].ToString() == "1") && (rows[34].ToString() == "1"))
                        {%>
                    <tr style="background-color: #FFFF99">
                        <td><%=i %></td>
                        <td><%=rows[20].ToString() %></td>
                        ...
                        <td>
                            ...
                            <a href="#" title="Finished" onclick="openEditModal2('<%= rows[0].ToString() %>','<%= rows[1].ToString() %>','1','<%= rows[35].ToString() %>','<%= rows[19].ToString() %>')">
                    ...
                    <%} %> 
                    <%else if ((rows[36].ToString() == "1") && (rows[34].ToString() == "0")) %>
                    <%{ %>
                        <tr style="background-color: #99FFFF">
                        <td><%=i %></td>
                        <td><%=rows[20].ToString() %></td>
                        ...
                        <%-- <td><%=rows[23].ToString() %></td>--%>
                        <td><%=rows[24].ToString() %></td>
                        <td><input type="checkbox" id="<%= rows[0].ToString() %>" value="<%= rows[0].ToString() %>"></td>
                    </tr>
                    <%} %>
                    ...
                    <tr style="background-color: #66FF33">
                        ...
                        <td>
                            ...
                            <a href="#" title="history" onclick="openEditModal5('<%= rows[0].ToString() %>','<%= rows[1].ToString() %>','<%= rows[5].ToString() %>','<%= rows[35].ToString() %>','<%= rows[42].ToString() %>','<%= rows[40].ToString() %>','<%= rows[43].ToString() %>','<%= rows[41].ToString() %>')">
                    ...
                    <%else
                        {%>
                    <%if (rows[15].ToString() == "Urgent" && rows[38].ToString() != "0")
                        {%>
                    <tr style="background-color: #FFFF99">
                        <td><%=i %></td>
                        <td><%=rows[20].ToString() %></td>
                    ...
                    <tr style="background-color: #FFC1C1">
                        ...
                        <td>
                            ...
                            <a href="#" title="Remove check" onclick="openEditModal4('<%= rows[0].ToString() %>','<%= rows[1].ToString() %>','<%= rows[2].ToString() %>')"><i class="far fa-trash-alt"></i></a>
                            <a href="#" title="history delete" onclick="openEditModal6('<%= rows[0].ToString() %>','<%= rows[1].ToString() %>','<%= rows[5].ToString() %>','<%= rows[26].ToString() %>','<%= rows[49].ToString() %>','<%= rows[50].ToString() %>')">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <span style="color: red; font-size: 11px; font-style: italic;" id="qty_sample_test2">(*)</span>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtgroupcode" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" runat="server" id="btncheck_addnormal2" onserverclick="BtnAddClickRosh" class="btn btn-primary"><i class="fas fa-download"></i>Save</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row">
                            <div>
                                <h4 class="modal-title" id="headerTag" style="float: left">Select Ok/NG Type Rosh</h4>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtremark_gach2" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#btncheck_addnormal2").css("display", "none");

            document.getElementById("partno_search").disabled = true;

            $("#filter_type2").prop("readonly", "true");
            ...
            $("#txtgroupcode").prop("readonly", true);
        ...
        $('#Qtysmaple').change(function () {
            ...
            $(this).val(val);
            //if (val === '' || val === "0") {  //cho phep nhap QTY sample =0
            if (val === '') {
                $("#qty_sample_test2").text("You input QTY Sample NG");
                $("#btncheck_addnormal2").css("display", "none");
            }
            else {
                $("#qty_sample_test2").text("*");
                $("#btncheck_addnormal2").css("display", "block");
            }
        });

        //Response.Redirect("PrintpartcardQC.aspx");

        //alert(ketqua);
        //$.ajax({
        //    type: "POST",
        //    url: "RoshInspection.aspx/GetMaHangPrint",
        //    contentType: "application/json; charset=utf-8",
        //    data: JSON.stringify({ 'data': ketqua }),
        //    dataType: "json",
        ...
        //    //alert("test");
        //    $('#userexport').css("display", "block");
        //});

        //$('#finishexport').change(function () {
        //    var txtuser_export = this.value();
        //    var data = { userid: txtuser_export };
        //    $.ajax({
        //        type: "POST",
        //        contentType: "application/json; charset=utf-8",
        //        url: "RoshInspection.aspx/FunExportCSV",
        ...
        $("#dr_filter_cate").change(function () {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "RoshInspection.aspx/getcategogy",
                data: JSON.stringify(data),
                dataType: "json",
                success: function (data) {
                    //var str_ = data.d;
        ...
        $("#dr_filter_both").change(function () {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "RoshInspection.aspx/getfilterboth_rosh",
                data: JSON.stringify(data),
                dataType: "json",
                success: function (data) {
                    //var str_ = data.d;
                    if (data.d == "OK") {
                        window.location.href = "RoshInspection.aspx?filterboth=" + typefilter;
                    } else {
                       window.location.href = "RoshInspection.aspx";
                    }
                    //var catchuoi = str_.split(","); //catchuoi[0] == "OK"                        
        ...
        function openEditModal5(txtid, txtmahang, txtqtylot, txtqtysample, txtstarttime, txtusercheck, txtendtime, txtuserfinish) {
            $("#txtid5").val(txtid);
            $("#material5").val(txtmahang);
            $("#qtylot5").val(txtqtylot);
            $("#qtysample5").val(txtqtysample);
            //$("#qtytest5").val(''); //rosh khong can 
            //$("#qtyNG5").val('');   //rosh khong can
        ...
        function openEditModal(txt_id, txt_mahang, txt_vitri, txt_soluong, txt_invoice, txt_weightofjig, txt_totalcycle, trangthai, txt_groupcode) {
            $("#idcheck").val(txt_id);
            ...
            //groupcode
            $("#txtgroupcode").val(txt_groupcode);
            ...
            if (trangthai == "0") {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "RoshInspection.aspx/checkcombine_qty_rosh",
                    data: JSON.stringify(data),
                    dataType: "json",
                    success: function (data) {
                        var str_ = data.d;
