<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMaterMVTPUS.aspx.cs" Inherits="FreeLayout.frmMaterMVTPUS" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Mater MVT PUR</title>
...
<body>
    <form id="form1" runat="server">
        <div class="card">
            <div class="card-header">
                <div class="col-sm-12">
                    <h3><b style="font-size: 30px;">Setting Mater MVT PUR</b></h3>
                    <br />
                    <p style="color: blue;">
            ...
            <table id="example" class="table table-striped table-bordered" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr role="row">
                        ...
                        <td><%=rows["NameCode"].ToString()%></td>
                        <td><%=rows["TypeRoshHalb"].ToString()%></td>
                        <td><%=rows["Typevendor"].ToString()%></td>
                        <td><%=rows["MVTvendor"].ToString()%></td>
                        <td><%=rows["TypePSNV"].ToString()%></td>
                        <td><%=rows["MVTPSNV"].ToString()%></td>
                        <td>
                            <a href="#" class="btn btn-info btn-sm" title="eidt item" onclick="openEditModal3('<%= rows["ID"].ToString() %>',
                                '<%= rows["Plant"].ToString() %>',
                                '<%=rows["Sloc"].ToString() %>',
                                '<%=rows["Description"].ToString() %>',
                                '<%=rows["Costcenter"].ToString() %>',
                                '<%=rows["NameCode"].ToString() %>',
                                '<%=rows["TypeRoshHalb"].ToString() %>',
                                '<%=rows["Typevendor"].ToString() %>',
                                '<%=rows["MVTvendor"].ToString() %>',
                                '<%=rows["TypePSNV"].ToString() %>',
                                '<%=rows["MVTPSNV"].ToString() %>'
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add Mater MVT PUR</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="ID">Costcenter</label>
                                <asp:TextBox ID="Costcenterid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <label for="ID">NameCode</label>
                                <asp:TextBox ID="NameCodeid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
                                <label for="ID">TypeRoshHalb</label>
                                <asp:TextBox ID="TypeRoshHalbid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <label for="ID">Typevendor</label>
                                <asp:TextBox ID="Typevendorid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
                                <label for="ID">MVTvendor</label>
                                <asp:TextBox ID="MVTvendorid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <label for="ID">TypePSNV</label>
                                <asp:TextBox ID="TypePSNVid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
                                <label for="ID">MVTPSNV</label>
                                <asp:TextBox ID="MVTPSNVid" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                        </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row">
                            <div>
                                <h4 class="modal-title" id="headerTag1" style="float: left">Update infor Master MVT PUR</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="ID">Costcenter</label>
                                <asp:TextBox ID="idCostcenter" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
                                <label for="ID">NameCode</label>
                                <asp:TextBox ID="idNameCode" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="ID">TypeRoshHalb</label>
                                <asp:TextBox ID="idTypeRoshHalb" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
                                 <label for="ID">Typevendor</label>
                                 <asp:TextBox ID="idTypevendor" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="ID">MVTvendor</label>
                                <asp:TextBox ID="idMVTvendor" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
                                 <label for="ID">TypePSNV</label>
                                 <asp:TextBox ID="idTypePSNV" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="ID">MVTPSNV</label>
                                <asp:TextBox ID="idMVTPSNV" CssClass="form-control" placeholder="" runat="server"></asp:TextBox>
                            </div>
                            <div class="col-md-6">
    ...
    <script type="text/javascript">  
        ...
        function openEditModal3(id, Plant, Sloc, Description, Costcenter, NameCode, TypeRoshHalb, Typevendor, MVTvendor, TypePSNV, MVTPSNV) {
            $("#IDedit").val(id);
            $("#idPlant").val(Plant);
            $("#idSloc").val(Sloc);
            $("#idDescription").val(Description);
            $("#idCostcenter").val(Costcenter);
            $("#idNameCode").val(NameCode);
            $("#idTypeRoshHalb").val(TypeRoshHalb);
            $("#idTypevendor").val(Typevendor);
            $("#idMVTvendor").val(MVTvendor);
            $("#idTypePSNV").val(TypePSNV);
            $("#idMVTPSNV").val(MVTPSNV);
