...
namespace FreeLayout
{
    public partial class Main_test : System.Web.UI.Page
    {
        ...
        {
            dt = DataConn.StoreFillDS("Get_mater_list_MCS", System.Data.CommandType.StoredProcedure);
        }     
        
        protected void Search_MCS_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                dt = DataConn.StoreFillDS("Get_mater_list_MCS_date", System.Data.CommandType.StoredProcedure, _date2);
